            ...
            <div className="area_list_model_class p-4" style={{backgroundColor: "white"}}>
                <Segment compact secondary  color="teal">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-12 col-lg-4">
                            <strong className="mt-3 p-1">Introduccion a la libreria ( React ) <br/> <br/><Icon name="clock" />5 minutos</strong>
                        </div>
                        <div className="col-12 col-lg-4">
                            <strong className="mt-3"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum ipsam commodi quas pariatur eveniet possimus similique accusamus omnis. </strong>
                        </div>
                    </div>
                </Segment>
                <Segment compact>
